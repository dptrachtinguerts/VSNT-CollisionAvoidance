...
inline cv::Rect to_cv_rect( const sensor_msgs::msg::RegionOfInterest& roi, const image_type& img ) {
...
inline bool is_cloud_valid( const sensor_msgs::msg::PointCloud2::SharedPtr& cloud ) {
    return 
        ( cloud )
